...
### 追加で必要な物
- Kail Choc V2互換スイッチ：　個人的にDeepSeaMiniがおすすめ。Lofreeなども。ChocV1も一応刺さりますがキーキャップの選択肢が減ります。
- MX軸ロープロファイルキーキャップ：　MX軸なら通常キーキャップも一部適合。
- 3.7Vリチウムポリマーバッテリー：　寸法xxxxx以下、ソケットのピッチ2.0mm　※ソケットの極性に注意！
- USB-Cケーブル：　マグネット式がおすすめ。
- プラスドライバー
- はんだごて一式：　アマゾンの温度調整付きはんだごてセットがおすすめ。
- ケースの滑り止め：　グリップラスが評判良いです。
