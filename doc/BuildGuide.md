...
　　
### FFCケーブルをPCBに取り付け
- ソケット尾部にある爪をやさしく引き上げ、FFCケーブルの金属面が手前に見える方向に差し込み、ソケットの爪を押し下げます。
> [!WARNING]
...
### トラックパッドとD-Pad取り付け
- ケースから伸びてるFFCケーブルにそれぞれトラックパッドとDpadを装着してください。
...
- 接続後、軽く動作チェックをして問題なさそうなら、バッテリーをケースへ両面テープ等で固定してください。
> [!WARNING]
