...
|必須| 名前 | 備考 |参考商品|
|:-|:-|:-|:-|
|★|はんだごてセット|アマゾンの温度調整付きはんだごて改善版15点セット（ピンセット、はんだ吸い取り線、フラックス付き）がおすすめ。極細のこて先が1本あるとなお良し。|[amazon](https://www.amazon.co.jp/dp/B0CM1WJB5X/)|
|★|プラスドライバー|M3ネジ締める用。||
...
- PCBに電源スイッチカバーを取り付け、ケースのアウターとボトムプレートを嵌め込んでいきます。
> [!WARNING]
