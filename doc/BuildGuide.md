...
- PCB裏面にある穴からマイコンの背面パッドへはんだづけを行います（穴２つ、マイコンの背面パッド４つ）。
> [!TIP]
> - 先にはんだごてを穴に差し込んで左右どちらかの背面パッド＆PCBのスルーホール（金属部分）を3秒ほど余熱し、スルーホール側からはんだを流し込み、こて先を動かして少しなじませると良い感じになります。
